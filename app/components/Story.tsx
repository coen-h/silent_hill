  ...
  return (
    <section id="story" className="w-screen h-screen relative flex justify-center items-center">
      ...
      <div className="absolute w-full flex flex-col items-center gap-2">
        ...
        <div className="flex bg-black/50 relative backdrop-blur rounded-lg w-full max-w-[1400px] h-[600px]">
          <img className="absolute right-0 h-full opacity-20" src='/note.webp' />
          <img className="absolute left-0 bottom-2 h-80 opacity-20 rounded-lg" src='/knife.webp' />
